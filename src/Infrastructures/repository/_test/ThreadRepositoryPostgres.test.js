  ...
  describe('behavior test', () => {
    ...
    describe('addThread function', () => {
      it('should persist new thread and return added thread correctly', async () => {
        await UsersTableTestHelper.addUser({ id: 'user-123456', username: 'Alpha' });
    ...
    describe('checkAvailabilityThread function', () => {
      ...
      it('should not throw NotFoundError if thread available', async () => {
        // Arrange
        const threadRepositoryPostgres = new ThreadRepositoryPostgres(pool, {});
        await UsersTableTestHelper.addUser({ id: 'user-123456789', username: 'Alpha' });
        await ThreadsTableTestHelper.addThread({ id: 'thread-h_123', body: 'some thread content', owner: 'user-123456789' });
