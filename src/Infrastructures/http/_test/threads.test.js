...
describe('/threads endpoint', () => {
  ...
  describe('when POST /threads', () => {
    ...
    it('should response 201 and create new thread', async () => {
      ...
      expect(responseJson.data.addedThread.title).toEqual('some thread title');
    });
  });
  describe('when GET /threads/{threadId}', () => {
    ...
    it('should response 200 and return detail thread', async () => {
      ...
      expect(responseJson.data.thread.title).toEqual('some thread title');
      expect(responseJson.data.thread.body).toEqual('some thread content');
      expect(responseJson.data.thread.username).toEqual('Alpha');
